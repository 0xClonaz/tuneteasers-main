...
app.get("/", (req, res) => {
  res.send("Szevasz üdv. a MusicGuesrr-ben!")
})
...
io.on("connection", (socket) => {
  ...
  socket.on("create_room", (data) => {
    ...
    const randomImage = "https://www.economist.com/cdn-cgi/image/width=1424,quality=80,format=auto/content-assets/images/20240203_BLP520.jpg"
    const player = {
      id: socket.id,
      name,
      score: 0,
  ...
  socket.on("join_room", (data) => {
    ...
    if (!room || room.gameStarted) {
      ...
      // Create a new player object with a unique ID and scorea
      const randomImage = "https://www.economist.com/cdn-cgi/image/width=1424,quality=80,format=auto/content-assets/images/20240203_BLP520.jpg"
